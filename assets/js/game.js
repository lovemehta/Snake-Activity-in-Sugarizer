...
var Game = {
    ...
    create : function() {
        ...
        squareSize = 30;                // The length of a side of the squares. Our image is 15x15 pixels.
        score = 0;                      // Game score.
        speed = 0;                      // Game speed.
        ...
        game.stage.backgroundColor = '39E028';
        ...
        textStyle_Key = { font: "bold 14px sans-serif", fill: "#400b41", align: "center" };
        ...
        // Speed.
        game.add.text(1100, 20, "SPEED", textStyle_Key);
        speedTextValue = game.add.text(1158, 18, speed.toString(), textStyle_Value);
    ...
    generateApple: function(){
        ...
        var randomX = Math.floor(Math.random() * 40 ) * squareSize,
            randomY = Math.floor(Math.random() * 19 ) * squareSize;
